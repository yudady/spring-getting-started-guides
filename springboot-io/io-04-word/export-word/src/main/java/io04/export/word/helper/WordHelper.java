package io04.export.word.helper;
...
//	ResourceLoader resourceLoader;
	...
	public ByteArrayInputStream generateWord() throws IOException, InvalidFormatException {
//		String imgFile = resourceLoader.getResource("spring.png").getURL().toString();
