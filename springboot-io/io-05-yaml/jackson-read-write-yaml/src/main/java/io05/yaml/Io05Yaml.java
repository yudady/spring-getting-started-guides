...
import io05.yaml.model.Order;
import io05.yaml.model.OrderLine;
import java.io.File;
...
public class Io05Yaml implements CommandLineRunner, ApplicationRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(Io05Yaml.class, args);
	}
